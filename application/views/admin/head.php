<head>
    ...
    <link href="<?= base_url(); ?>assets/css/timepicki.css" rel="stylesheet" type="text/css">

    <script type="text/javascript" src="<?php echo base_url(); ?>global_assets/js/main/jquery.min.js"></script>
    ...
    <script type="text/javascript" src="<?= base_url() ?>assets/js/maps/google/basic/basic.js"></script>
    ...
    <!--<script src="<?php echo base_url(); ?>global_assets/js/demo_pages/form_actions.js"></script>-->
